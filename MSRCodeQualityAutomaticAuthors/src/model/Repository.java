...
public class Repository implements Comparable<Repository>{
	...
	private String author, system, commitId, className, measure, metricName, beforeAfter;
	private double value;
	private boolean exist;
	
	public Repository(String author, String system, String commitId, String className,
	...
	public Repository(String system, String commitId, String className,
			String measure, String metricName, String beforeAfter, double value, boolean exist) {
		this.system = system;
		this.commitId = commitId;
		this.className = className;
		this.measure = measure;
